...
type
  TExtrapolation = class
    ...
    public
      ...
      constructor Create();
      function linear(Xlist, YList: TStringList): string;
      function exponential(Xlist, YList: TStringList): string;
      function logarithmic(Xlist, YList: TStringList): string;
      function logarithmic2(Xlist, YList: TStringList): string;
  end;
...
function TExtrapolation.linear(XList, YList: TStringList): string;
var
  numElements : Integer;
  xAvg, yAvg : Double;
...
function TExtrapolation.exponential(Xlist, YList: TStringList): string;
var
  YLnList: TStringList;
  i : Integer;
  ResTmp : TResult;
...
function TExtrapolation.logarithmic(Xlist, YList: TStringList): string;
var
  YLnList: TStringList;
  i : Integer;
  ResTmp : TResult;
...
function TExtrapolation.logarithmic2(Xlist, YList: TStringList): string;
var
