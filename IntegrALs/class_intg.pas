...
begin
  ...
  ShowMessage('- '+FloatToStr(sum_1+f(a+h)));   ShowMessage('-- '+FloatToStr(sum_2+f(a+2*h))); ShowMessage('--- '+FloatToStr(sum_3+f(a+3*h)));
...
begin
  ...
  repeat
    ShowMessage('1111 '+FloatToStr(xi));
    sum_1:=sum_1+ f(xi);
    ShowMessage('summ11 '+FloatToStr(sum_1));
    xi:=xi+ 3*h;
    ShowMessage('iii'+FloatToStr(xi));
    ShowMessage('LLL '+ FloatToStr(b-2*h));
  until (xi> b-2*h);
